...
@Component({
  tag: 'uni-carousel',
  styleUrl: 'uni-carousel.css',
  shadow: true,
})
export class UniCarousel {
  @Element() root: HTMLElement;

  @State() carouselItemList: NodeListOf<HTMLUniCarouselItemElement>;
  ...
  componentDidLoad() {
    const carouselItemList = this.root.querySelectorAll('uni-carousel-item');
